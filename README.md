...
> If I had the time, I would actually have liked to add Ace card supervalues. By this I mean, I wish the playing parties could, in the case of drawing a ace, be able to chose to value it at 10 or 1, like one can in actual blackjack. I could also have integrated some HTML/CSS code to make the program more visually interesting (note that I say "could", since I wouldn't actually want to do that). Finally, I would have ptimised the "show/hide text" function. 
